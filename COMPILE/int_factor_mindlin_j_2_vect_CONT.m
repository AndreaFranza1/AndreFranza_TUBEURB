function [ uxij_2,uyij_2,uzij_2 ] = int_factor_mindlin_j_2_vect_CONT( Xi,Yi,Zi,Xj,Yj,Zj,Gs,nus )
...
z=Zi;
c=Zj;
y=-(Xi-Xj); %for the reference system
x=Yi-Yj;
...
% uxij_2=v;
uxij_2=-1*v; %for the reference system
uyij_2=u;
uzij_2=w;
