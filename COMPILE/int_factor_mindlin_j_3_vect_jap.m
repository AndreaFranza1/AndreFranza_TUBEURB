function [ uxij_3,uyij_3,uzij_3 ] = int_factor_mindlin_j_3_vect_jap( Xi,Yi,Zi,Xj,Yj,Zj,Gs,nus,kh,kv,passo,npali,nnodes )
...
t3U=+6.*c.*z.*(z+c)./R2.^5;  %mindlin opposite
t4U=-4.*(1-nus).*(1-2.*nus)./R2./(R2+z+c); %mindlin opposite
U=1./16./pi./Gs./(1-nus).*(t1U+t2U+t3U+t4U);

w(isnan(w(:,1)))=1/kv/passo;
