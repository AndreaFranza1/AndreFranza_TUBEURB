...
E=30e9;
bc=0.3; dc=0.3;     % Columns 
bb=0.3; db=0.5;     % Beams 
bf=0.3; df=0.3;     % foundation beams 
...
supports=[1 0 0 1;
          2 0 0 1;
          3 0 0 1;
          4 0 0 1]; %write the nodes number @ supports
...
% uy2=0;
% uy3=0;
support_settlement=[1 1 0 0;
                    2 0 0 0;
                    3 0 0 0;
                    4 0 0 0]; %write the nodes number @ supports settlement
