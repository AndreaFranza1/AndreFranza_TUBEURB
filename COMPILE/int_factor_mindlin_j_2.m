function [ uxij_2,uyij_2,uzij_2 ] = int_factor_mindlin_j_2( Xi,Yi,Zi,Xj,Yj,Zj,Gs,nus )
...
t5u=2*zi*zj/R2^3*(1-3*x^2/R2^2);
t6u=4*(1-nus)*(1-2*nus)/(R2+zi+zj)*(1-(x^2/R2/(R2+zi+zj)));
